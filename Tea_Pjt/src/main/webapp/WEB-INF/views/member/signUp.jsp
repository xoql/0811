...
<body>
	<form action="signup.do" method="post" onsubmit="return signupChk()">
		<h3>회원가입</h3>
		<p>
		<input id="user_id" type="text" name="user_id" placeholder="ID">
		<label id="idMsg">*</label>
		<p>
		<input id="password" type="password" name="password" placeholder="PASSWORD" >
		<p>
		<input id="password2"type="password" placeholder="CHECK PASSWORD">
		...
		<p><!-- address -->
			<input type="post" name="address1" id="sample6_postcode" placeholder="우편번호">
			<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
			<input type="addess1" name="address2" id="sample6_address" placeholder="주소">
			<input type="addess2" name="address3" id="sample6_address2" placeholder="상세주소">
